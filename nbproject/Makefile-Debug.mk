...
${OBJECTDIR}/read_config.o: nbproject/Makefile-${CND_CONF}.mk read_config.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DVERSION=\"${GIT_VERSION}\" -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/read_config.o read_config.c
...
${OBJECTDIR}/read_config_nomain.o: ${OBJECTDIR}/read_config.o read_config.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -DVERSION=\"${GIT_VERSION}\" -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/read_config_nomain.o read_config.c;\
	else  \
